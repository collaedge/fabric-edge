...
set -x
peer channel fetch 0 $CHANNEL_NAME.block -o orderer.edge.com:7050 --ordererTLSHostnameOverride orderer.edge.com -c $CHANNEL_NAME --tls --cafile $ORDERER_CA >&log.txt
res=$?
set +x
cat log.txt
